...
export const loadCommandsInteraction = async (client: Client, interaction: CommandInteraction): Promise<void> => {
    ...
    const command = cmds.find(cmd => cmd.default.name === interaction.commandName);
